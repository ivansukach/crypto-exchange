...
void main() {
  runApp(MaterialApp(
      ...
      home: HomePage())); //A convenience widget that wraps a number of widgets
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Plasma(
          ...
          speed: 6.00,
          offset: 0.00,
          blendMode: BlendMode.difference,//The Color Dodge blend mode divides the bottom layer by the inverted top layer.
          child: Container(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                top: -height/10,
                left: 0,
                child: OpacityAnimation(1.0, Container(
                  width: width,
                  height: height/2,
                  decoration: BoxDecoration(
                    image: const DecorationImage(
                      image: AssetImage('assets/images/shapeOfBackground.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ))
              ...
              Positioned(
                  top: -height/5,
                  left: 0,
                  child:  OpacityAnimation(1.3, Container(
                    width: width,
                    height: height/2,
                    decoration: BoxDecoration(
                      image: const DecorationImage(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                  OpacityAnimation(1.5, Text("Welcome",
